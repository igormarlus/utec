            ...
            <div class="container">
                ...
                <div class="mws-panel grid_4">
                    ...
                    <div class="mws-panel-header">
                        <span><i class="icon-add-contact"></i> Novo usuário da plataforma</span>
                    </div>
                    
                    <div class="mws-panel-body no-padding">
                        
                        <form id="form" name="form" class="mws-form" method="post" action="<?php echo base_url() ?>adm/usuarios/cadastrar">
                            ...
                            <div class="mws-form-inline">
                                    ...
                                    <div class="mws-form-item">
                                        <select name="id_unidade">
                                        	<? foreach($unidades->result() as $unidade){ ?>
                                            	<option value="<?=$unidade->id?>"><?=$unidade->titulo?> <?=$unidade->cidade?> <?=$unidade->uf?></option>
                                            <? } ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="mws-form-row bordered">
                                    ...
                                    <div class="mws-form-item">
                                        <input type="text" name="nome" class="large">
                                    </div>
                                </div>
                                ...
                                <div class="mws-form-row bordered">
                                    ...
                                    <div class="mws-form-item">
                                        <input type="password" id="confirma" name="confirma" class="large">
                                    </div>
                                </div>
                            ...
                            <div class="mws-button-row">
                                <input type="submit" id="botao" value="Cadastrar usuário" class="btn btn-danger">
                            </div>
