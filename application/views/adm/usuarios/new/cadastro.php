                  ...
                  <div class="col-lg-12">
                    <div class="element-wrapper">
                      ...
                      <div class="element-box">
                        ...
                        <form id="form" name="form" class="mws-form" method="post" action="<?php echo base_url() ?>index.php/adm/usuarios/cadastrar" enctype='multipart/form-data'>
                        ...
                        <!--   <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="mws-form-item">
                                <!-- <input type="hidden" name="id" value="<?php #echo $usuario->id; ?>"> -->
                                  <input type="text" name="nome" class="form-control" placeholder="Preencha o nome completo" value="<?php #echo $usuario->nome; ?>">
                              </div>
                          </div>
                          ...
                          <? if($nivel == 5){ ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="mws-form-item">
                                    <input type="text" name="afiliacoes" class="form-control" placeholder="Pai, mãe..." value="<?php #echo $usuario->afiliacoes; ?>">
                                </div>
                            </div>
                          <? } ?>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                              <div class="form-group">
                                  ...
                                  <div class="mws-form-item">
                                      <input type="date" name="dt_nascimento" class="form-control" placeholder="DD/MM/AAAA value="<?php #echo $usuario->dt_nascimento; ?>">
                                  </div>
                              </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                              <div class="form-group">
                                  ...
                                  <div class="mws-form-item">
                                      <input type="text" name="email" class="form-control" placeholder="aaa@aaa.com" value="<?php #echo $usuario->email; ?>">
                                  </div>
                              </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="mws-form-item">
                                    <input type="text" name="telefone" class="form-control" placeholder="DDD + Número" value="<?php #echo $usuario->telefone; ?>">
                                </div>
                            </div>    
                          </div>
                          ...
                          <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="mws-form-item">
                                    <input type="text" name="cpf" class="form-control" placeholder="000.000.000-00" value="<?php #echo $usuario->cpf; ?>">
                                </div>
                            </div>  
                          </div>
                        </div>
                            ...
                            <div class="row">
                              <div class="col-sm-6">
                                  <div class="form-group">
                                      ...
                                      <div class="mws-form-item">
                                          <input type="text" name="cep" placeholder="00000-000" class="form-control" value="<?php #echo $usuario->cep; ?>">
                                      </div>
                                  </div>  
                              </div>
                            </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-6">  
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="mws-form-item">
                                        <input type="text" name="endereco" class="form-control" placeholder="Rua, logradouro..." value="<?php #echo $usuario->endereco; ?>">
                                    </div>
                                </div>
