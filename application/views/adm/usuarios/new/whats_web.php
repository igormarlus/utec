            ...
            <div class="ssg-content">
              <div class="ssg-items ssg-items-boxed">
                <a class="ssg-item" href="users_profile_big.html">
                  <div class="item-media" style="background-image: url(<?=base_url()?>img/company6.png)"></div>
                  <div class="item-name">
                    Integ<span>ration</span> with API
                  </div>
                </a><a class="ssg-item" href="users_profile_big.html">
                  <div class="item-media" style="background-image: url(<?=base_url()?>img/company7.png)"></div>
                  <div class="item-name">
          ...
          <div class="search-suggestions-group">
            ...
            <div class="ssg-content">
              <div class="ssg-items ssg-items-list">
                <a class="ssg-item" href="users_profile_big.html">
                  <div class="item-media" style="background-image: url(<?=base_url()?>img/avatar1.jpg)"></div>
                  <div class="item-name">
                    John Ma<span>yer</span>s
                  </div>
                </a><a class="ssg-item" href="users_profile_big.html">
                  <div class="item-media" style="background-image: url(<?=base_url()?>img/avatar2.jpg)"></div>
                  <div class="item-name">
                    Th<span>omas</span> Mullier
                  </div>
                </a><a class="ssg-item" href="users_profile_big.html">
                  <div class="item-media" style="background-image: url(<?=base_url()?>img/avatar3.jpg)"></div>
                  <div class="item-name">
        ...
        <div class="menu-mobile menu-activated-on-click color-scheme-dark">
          ...
          <div class="menu-and-user">
            <div class="logged-user-w">
              <div class="avatar-w">
                <img alt="" src="<?=base_url()?><?=base_url()?>img/avatar1.jpg">
              </div>
                ...
                <div class="os-dropdown light message-list">
                  <ul>
                    ...
                    <li>
                      <a href="#">
                        <div class="user-avatar-w">
                          <img alt="" src="<?=base_url()?><?=base_url()?>img/avatar2.jpg">
                        </div>
                        <div class="message-content">
                          <h6 class="message-from">
                            Phil Jones
                    ...
                    <li>
                      <a href="#">
                        <div class="user-avatar-w">
                          <img alt="" src="<?=base_url()?><?=base_url()?>img/avatar3.jpg">
                        </div>
                        <div class="message-content">
                          <h6 class="message-from">
                            Bekky Simpson
                    ...
                    <li>
                      <a href="#">
                        <div class="user-avatar-w">
                          <img alt="" src="<?=base_url()?><?=base_url()?>img/avatar4.jpg">
                        </div>
                        <div class="message-content">
                          <h6 class="message-from">
                            Alice Priskon
                ...
                <div class="full-chat-i">
                  <div class="full-chat-left">
                    ...
                    <div class="user-list">
                      <? if($conversas->num_rows() > 0){ ?>
                        <?  foreach($conversas->result() as $chat){ 
                          $dd_user_whats = $this->padrao_model->get_by_matriz('telefone',$chat->contato,'pi_whats_users')->row();
                          $qr_user_whats = $this->padrao_model->get_by_matriz('telefone',$chat->contato,'pi_whats_users');
                          #$chat_last = $this->db->query("SELECT * FROM pi_whats WHERE contato =  '".$chat->contato."' ORDER BY dt desc LIMIT 1");
                          $chat_last = $this->db->query("SELECT * FROM pi_whats WHERE contato =  '".$chat->contato."' ORDER BY dt desc");

                          #$this->db->where('id',$dd_user_whats->id_user);
                          $this->db->where('telefone',$chat->contato);
                           $qr_whats_user = $this->db->get('pi_whats_users');
                                 if($qr_whats_user->num_rows() > 0){
                                    $dd_user = $qr_whats_user->row();
                                    $nome = $dd_user_whats->nome;
                                    $telefone = $dd_user_whats->telefone;
                                    $foto = $dd_user_whats->img;
                                    $tipo_pro = $dd_user_whats->id_produto;
                                    $dt_reg = $dd_user->dt_registro;
                                   }else{
                                    #echo " - ";
                                    $tipo_pro = 0;
                                    $dt_reg = '-';
                                    ...
                                    $telefone = "-";
                                    $foto = "";
                                    #echo print_r($dd_user_whats);
                                   }
                        ?>
                      <div class="user-w" data-whats="<?=$chat->contato?>">
                        <div class="avatar with-status status-green">
                          <? if($foto != ""){ ?>
                          <img src="<?=$foto?>" alt="-" style="border-radius: 50%">
                        <? }else{ ?>
                          <img alt="" src="<?=base_url()?>img/avatar1.jpg" style="opacity: 0.1;">
                        <? } ?>
                  ...
                  <div class="full-chat-middle">
                    ...
                    <div class="chat-content-w">
                      <div class="chat-content" id="box_msgs">
                    ...
                    <div class="chat-info-section">
                      ...
                      <div class="ci-content">
                        <div class="ci-photos-list">
                          <img alt="" src="<?=base_url()?>img/portfolio9.jpg"><img alt="" src="<?=base_url()?>img/portfolio2.jpg"><img alt="" src="<?=base_url()?>img/portfolio12.jpg"><img alt="" src="<?=base_url()?>img/portfolio14.jpg">
                        </div>
                      </div>
                    </div>
                  </div>
    ...
    <script>
      $(document).ready(function(){
        ...
        $(".user-w").click(function(){
            ...
            $("#box_msgs").html("Carregando...");
            var whats_user = $(this).attr('data-whats');
            $.get("<?=base_url()?>adm/usuarios/get_conversa/"+whats_user+"/<?=$this->session->userdata('id')?>" , function(conversa_whats){
              //conversa_whats
              $("#box_msgs").html(conversa_whats);
            })
        })
