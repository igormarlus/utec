...
<head>
    ...
    <meta property="og:url" content="https://utecnologia.com.br/alternativa-shosp">
    <meta property="og:title" content="Alternativa ao Shosp — UTecnologia Saúde">
    <meta property="og:description" content="Alternativa ao Shosp com prontuário, agenda, trial grátis e implantação simples para clínicas e consultórios.">
    ...
    <meta name="twitter:title" content="Alternativa ao Shosp — UTecnologia Saúde">
    <meta name="twitter:description" content="Alternativa ao Shosp com prontuário, agenda, trial grátis e implantação simples.">
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 2, "name": "Alternativa ao Shosp", "item": "https://utecnologia.com.br/alternativa-shosp"}
  ]
}
</script>
<script type="application/ld+json">
{
  ...
  "@type": "FAQPage",
  "mainEntity": [
    {"@type": "Question", "name": "Quando faz sentido buscar uma alternativa ao Shosp?", "acceptedAnswer": {"@type": "Answer", "text": "Quando a clínica quer avaliar uma operação mais simples de implantar, testar com trial antes de assinar e comparar o custo total com o estágio atual do negócio."}},
    {"@type": "Question", "name": "O UTecnologia Saúde serve para clínica pequena ou consultório?", "acceptedAnswer": {"@type": "Answer", "text": "Sim. O plano de entrada foi estruturado para profissional solo e consultórios menores, sem perder a possibilidade de subir para clínica com equipe depois."}},
    {"@type": "Question", "name": "Dá para avaliar sem migrar tudo de uma vez?", "acceptedAnswer": {"@type": "Answer", "text": "Sim. A recomendação é começar pelos pacientes ativos e pela agenda corrente. Isso reduz atrito e permite validar o sistema com segurança antes de uma migração maior."}}
  ]
}
</script>
</body>
