...
<script>
  ...
  gtag('config', 'AW-676174906');
    ...
    <meta charset="UTF-8">
    <title>Sistema para Ginecologia e Obstetrícia — UTecnologia Saúde</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Sistema para clínicas de ginecologia e obstetrícia com agenda, prontuário com DUM, idade gestacional e exames, e gestão de pacientes. Experimente grátis por 30 dias.">
    <link rel="canonical" href="https://utecnologia.com.br/sistema-para-ginecologia">
    <link rel="icon" type="image/png" sizes="512x512" href="<?=base_url('favicon.png')?>">
    <link rel="apple-touch-icon" href="<?=base_url('apple-touch-icon.png')?>">
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://utecnologia.com.br/sistema-para-ginecologia">
    <meta property="og:title" content="Sistema para Ginecologia e Obstetrícia — UTecnologia Saúde">
    <meta property="og:description" content="Agenda, prontuário com DUM e idade gestacional, e gestão de pacientes para ginecologia e obstetrícia. Teste grátis 30 dias.">
    ...
    <meta name="twitter:title" content="Sistema para Ginecologia e Obstetrícia — UTecnologia Saúde">
    <meta name="twitter:description" content="Agenda, prontuário e gestão para clínicas de ginecologia e obstetrícia. 30 dias grátis.">
    ...
    *{box-sizing:border-box;margin:0;padding:0;}
    ...
    .prontuario-stage::before{content:'Prontuário — Ginecologia/Obstetrícia';position:absolute;top:-12px;left:24px;font-size:11px;font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:var(--teal-md);background:var(--navy);padding:0 8px;z-index:10;}
...
<section class="hero">
    <div class="wrap">
        <div class="hero-inner">
            <div>
                <div class="eyebrow">Software para Ginecologia e Obstetrícia</div>
                <h1><em>Sistema para ginecologia</em> e obstetrícia</h1>
                <p class="hero-text">
                    Organize a agenda de consultas, acompanhe o pré-natal com prontuário estruturado
                    (DUM, idade gestacional, exames) e gerencie sua clínica ou consultório de
                    ginecologia — 100% online.
                </p>
                <div class="hero-cta">
                ...
                <div class="funciona-strip">
                    ...
                    <span class="funciona-chip">Ginecologista autônoma(o)</span>
                    <span class="funciona-chip">Consultório de ginecologia</span>
                    <span class="funciona-chip">Clínica com equipe multiprofissional</span>
                    <span class="funciona-chip">Obstetrícia e pré-natal</span>
            ...
            <div class="hero-card">
                <div class="topbar-dots">
                    ...
                    <span class="card-title-bar">Registro de Atendimento — Ginecologia</span>
                </div>
                <div class="card-body">
                    <div class="fm-grid2">
                        <div>
                            <label class="fm-label">DUM (Data Últ. Menstruação)</label>
                            <input class="fm-input" type="text" placeholder="Ex: 12/05/2026" readonly>
                        </div>
                        <div>
                            <label class="fm-label">Idade Gestacional</label>
                            <input class="fm-input" type="text" placeholder="Ex: 12 semanas" readonly>
                        </div>
                    </div>
                    <div class="fm-group">
                        <label class="fm-label">Exame Solicitado</label>
                        <select class="fm-select" disabled><option>USG Obstétrico</option></select>
                    </div>
                    <div class="fm-group">
                        <label class="fm-label">Conduta / Retorno</label>
                        <input class="fm-input" type="text" placeholder="Retorno em 4 semanas para novo USG" readonly>
                    </div>
...
<section class="prontuario-section">
    <div class="wrap">
        <div class="pront-header">
            ...
            <h2>Como o prontuário de ginecologia aparece na plataforma</h2>
            <p>DUM, idade gestacional, exames solicitados e conduta registrados por consulta — histórico completo do pré-natal e do acompanhamento ginecológico.</p>
        </div>
        <div class="prontuario-stage">
            <div class="prontuario-mock">
                <div class="pmock-topbar">
                    ...
                    <span class="pmock-title">Prontuário — Ginecologia · Fernanda Alves · 05/06/2026</span>
                </div>
                <div class="pmock-body">
                    <div class="pmock-group">
                        <div class="pmock-group-label">Queixa / Motivo</div>
                        <div class="pmock-row">
                            <div class="pmock-field-input">Retorno de pré-natal de rotina. Paciente refere bem-estar, sem intercorrências desde a última consulta.</div>
                        </div>
                    </div>
                    <div class="pmock-group">
                        <div class="pmock-group-label">DUM + Idade Gestacional</div>
                        <div class="pmock-row col2">
                            <div>
                                <div style="font-size:10px;color:rgba(255,255,255,.4);margin-bottom:4px;">DUM</div>
                                <div class="pmock-field-input">12/05/2026</div>
                            </div>
                            <div>
                                <div style="font-size:10px;color:rgba(255,255,255,.4);margin-bottom:4px;">Idade Gestacional</div>
                                <div class="pmock-field-input">28 semanas</div>
                            </div>
                        </div>
                    </div>
                    <div class="pmock-group">
                        <div class="pmock-group-label">Exame Solicitado</div>
                        <div class="pmock-row">
                            <div class="pmock-field-select">USG Obstétrico + Perfil biofísico fetal</div>
                        </div>
                    </div>
                    <div class="pmock-group">
                        <div class="pmock-group-label">Conduta / Retorno</div>
                        <div class="pmock-row">
                            <div class="pmock-field-input">Manter suplementação. Retorno em 4 semanas com resultado do USG.</div>
                        </div>
                    </div>
                    <div class="pmock-act">
...
<section class="section">
    <div class="wrap">
        ...
        <h2>O que o sistema oferece para sua clínica de ginecologia</h2>
        <p class="section-sub">Do agendamento ao acompanhamento do pré-natal — tudo organizado em um único sistema.</p>
        <div class="features-grid">
            <div class="feature-card">
                <div class="feature-icon">📋</div>
                <h3>Prontuário Obstétrico</h3>
                <p>Registre DUM, idade gestacional e a evolução de cada consulta de pré-natal no histórico da paciente.</p>
            </div>
            <div class="feature-card">
                <div class="feature-icon">📅</div>
                <h3>Agenda de Consultas</h3>
                <p>Organize consultas de rotina e retornos de pré-natal por profissional, com filtro por data e status.</p>
            </div>
            <div class="feature-card">
                <div class="feature-icon">🔬</div>
                <h3>Exames e Resultados</h3>
                <p>Solicite exames (USG, Papanicolau, Beta-hCG) e anexe laudos diretamente no prontuário da paciente.</p>
            </div>
            <div class="feature-card">
                <div class="feature-icon">👥</div>
                <h3>Multi-profissionais</h3>
                <p>Clínica com várias ginecologistas? Cada profissional gerencia suas próprias pacientes com acesso individualizado.</p>
            </div>
            <div class="feature-card">
                <div class="feature-icon">🏢</div>
            ...
            <div class="feature-card">
                ...
                <p>Visualize quantas consultas cada profissional realizou, em qual período e com qual status.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="section" style="background:var(--white);">
    <div class="wrap">
        ...
        <h2>Dúvidas sobre o sistema para ginecologia</h2>
        <p class="section-sub" style="margin-bottom:40px;"></p>
        <div class="faq-list">
            <div class="faq-item open">
                <div class="faq-q" onclick="this.closest('.faq-item').classList.toggle('open')">
                    O sistema calcula a idade gestacional automaticamente?
                    <span class="faq-chevron">▾</span>
                </div>
                <div class="faq-a">O prontuário tem campos estruturados para registrar DUM e idade gestacional a cada consulta. No momento não há uma calculadora obstétrica automática embutida — o registro é feito manualmente pelo profissional a cada atendimento, o que já garante o histórico completo da gestação.</div>
            </div>
            <div class="faq-item">
                <div class="faq-q" onclick="this.closest('.faq-item').classList.toggle('open')">
                    Posso registrar exames de pré-natal como USG e Papanicolau?
                    <span class="faq-chevron">▾</span>
                </div>
                <div class="faq-a">Sim. Você pode solicitar exames pelo sistema e anexar laudos, imagens e resultados diretamente no prontuário da paciente.</div>
            </div>
            <div class="faq-item">
                <div class="faq-q" onclick="this.closest('.faq-item').classList.toggle('open')">
                    Funciona para consultório com apenas 1 profissional?
                    <span class="faq-chevron">▾</span>
                </div>
                <div class="faq-a">Sim. O plano Solo é ideal para ginecologistas/obstetras autônomas(os): 1 profissional, 2 colaboradores (ex: recepcionista) e pacientes ilimitadas, por R$ 79/mês.</div>
            </div>
            <div class="faq-item">
                <div class="faq-q" onclick="this.closest('.faq-item').classList.toggle('open')">
                    A recepção pode acessar a agenda sem ver o prontuário?
                    <span class="faq-chevron">▾</span>
                </div>
...
<section class="section">
    <div class="wrap">
        <div class="cta-wrap">
            <h2>Organize sua clínica de ginecologia e obstetrícia</h2>
    ...
    <div class="wrap">
        <div class="footer-inner">
            ...
            <div class="footer-links">
                ...
                <a href="<?=base_url()?>sistema-para-clinicas">Todas as especialidades</a>
                <a href="<?=base_url()?>sistema-para-pediatria">Sistema para Pediatria</a>
...
<script type="application/ld+json">
{
  ...
  "operatingSystem": "Web",
  "url": "https://utecnologia.com.br/sistema-para-ginecologia",
  "description": "Sistema para clínicas de ginecologia e obstetrícia com agenda, prontuário com DUM e idade gestacional, e gestão de pacientes.",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 3, "name": "Sistema para Ginecologia", "item": "https://utecnologia.com.br/sistema-para-ginecologia"}
  ]
}
</script>
<script type="application/ld+json">
{
  ...
  "@type": "FAQPage",
  "mainEntity": [
    {"@type": "Question", "name": "O sistema calcula a idade gestacional automaticamente?", "acceptedAnswer": {"@type": "Answer", "text": "O prontuário tem campos estruturados para registrar DUM e idade gestacional a cada consulta. Não há calculadora obstétrica automática embutida no momento, mas o registro manual garante o histórico completo da gestação."}},
    {"@type": "Question", "name": "Posso registrar exames de pré-natal como USG e Papanicolau?", "acceptedAnswer": {"@type": "Answer", "text": "Sim. É possível solicitar exames pelo sistema e anexar laudos, imagens e resultados diretamente no prontuário da paciente."}},
    {"@type": "Question", "name": "Funciona para consultório com apenas 1 profissional?", "acceptedAnswer": {"@type": "Answer", "text": "Sim. O plano Solo é ideal para ginecologistas/obstetras autônomas: 1 profissional, 2 colaboradores e pacientes ilimitadas por R$ 79/mês."}}
  ]
}
</script>
</body>
